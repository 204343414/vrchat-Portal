...
//   方案：ProcessRigidbodyForPortal 入口扫描中，新收录且已在后侧(initialSide==-1)的
//         手持刚体按"本帧完成穿越"处理：当前位置投影到平面作穿越点立即传送，
//         随后加入对面门追踪（与主穿越路径同款簿记+clone兜底）。
//         只限手持刚体，避免误传停在门后结构上的普通刚体（如剪刀穿模斜坡）。
// ================================================================================
#if UNITY_EDITOR
